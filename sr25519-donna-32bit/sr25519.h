...
*/
REC_DEVICE void sr25519_keypair_from_seed(thread sr25519_keypair keypair, const thread sr25519_mini_secret_key seed);

/*
 * keypair: the output uniform keypair, 96 bytes long
 * seed: the input mini secret key, 32 bytes long
*/
REC_DEVICE void sr25519_uniform_keypair_from_seed(thread sr25519_keypair keypair, const thread sr25519_mini_secret_key seed);

/*
 * uniform_keypair: the output uniform keypair, 96 bytes long
 * ed25519_keypair: the ed25519 compatible keypair, 96 bytes long
*/
REC_DEVICE void sr25519_keypair_ed25519_to_uniform(thread sr25519_keypair uniform_keypair, const thread sr25519_keypair ed25519_keypair);
...
*/
REC_DEVICE void sr25519_sign(thread sr25519_signature signature, const thread sr25519_public_key public_key, const thread sr25519_secret_key secret, const thread uint8_t *message, unsigned long message_length);
...
*/
REC_DEVICE bool sr25519_verify(const thread sr25519_signature signature, const thread uint8_t *message, unsigned long message_length, const thread sr25519_public_key public_key);
...
*/
REC_DEVICE void sr25519_derive_keypair_soft(thread sr25519_keypair derived, const thread sr25519_keypair keypair, const thread sr25519_chain_code chain_code);
 ...
 * chain_code: the input chain code, 32 bytes long
*/
REC_DEVICE void sr25519_derive_public_soft(thread sr25519_public_key derived_public, const thread sr25519_public_key public_key, const thread sr25519_chain_code chain_code);
 ...
 * chain_code: the input chain code, 32 bytes long
*/
REC_DEVICE void sr25519_derive_keypair_hard(thread sr25519_keypair derived, const thread sr25519_keypair keypair, const thread sr25519_chain_code chain_code);
...
*/
REC_DEVICE VrfResult sr25519_vrf_sign_if_less(thread sr25519_vrf_out_and_proof out_and_proof, const thread sr25519_keypair keypair, const thread uint8_t *message, unsigned long message_length, const thread sr25519_vrf_threshold threshold);
...
*/
REC_DEVICE VrfResult sr25519_vrf_verify(const thread sr25519_public_key public_key, const thread uint8_t *message, unsigned long message_length, const thread sr25519_vrf_output output, const thread sr25519_vrf_proof proof, const thread sr25519_vrf_threshold threshold);
