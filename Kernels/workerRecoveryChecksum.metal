...
kernel void workerRecoveryChecksum(const device ushort* base_ids [[buffer(0)]],
                                   constant int& words_count [[buffer(1)]],
                                   const device int* missing_positions [[buffer(2)]],
                                   constant int& missing_count [[buffer(3)]],
                                   constant ulong& range_start [[buffer(4)]],
                                   constant ulong& range_count [[buffer(5)]],
                                   device ushort* out_ids [[buffer(6)]],
                                   device atomic_uint* out_count [[buffer(7)]],
                                   constant uint& out_capacity [[buffer(8)]],
