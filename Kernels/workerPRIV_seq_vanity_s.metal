...
kernel void workerPRIV_seq_vanity_s(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run_parity_walk(PrivVanityKindS, false, isResult, buffResult, precPtr, precPitch,
