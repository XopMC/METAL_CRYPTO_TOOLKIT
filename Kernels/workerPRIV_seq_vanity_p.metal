...
kernel void workerPRIV_seq_vanity_p(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run_parity_walk(PrivVanityKindP, false, isResult, buffResult, precPtr, precPitch,
                                mode, start_point, step, thread_steps_pub, startx_buf, starty_buf,
                                vanityTables, vanityTables + PRIV_VANITY_TABLE_WORDS,
                                ...
                                grid_position.x, thread_position.x, threads_per_threadgroup.x,
