...
kernel void workerPRIV_seq_vanity_c(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run_parity_walk(PrivVanityKindC, true, isResult, buffResult,
        precPtr, precPitch, mode, start_point, step, thread_steps_pub,
