...
kernel void workerPRIV_seq_vanity_cusr(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run(PrivVanityKindCusr, isResult, buffResult, precPtr, precPitch, mode, start_point,
