...
kernel void workerPRIV_seq_vanity_x(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run_parity_walk(PrivVanityKindX, false, isResult, buffResult, precPtr, precPitch,
