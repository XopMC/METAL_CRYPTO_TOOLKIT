...
kernel void workerPRIV_seq_vanity_u(device bool* isResult [[buffer(0)]],
    ...
    priv_vanity_run_full_y_walk(PrivVanityKindU, false, isResult, buffResult, precPtr,
                                precPitch, mode, start_point, step, thread_steps_pub,
                                startx_buf, starty_buf, vanityTables,
                                ...
                                xor_uc_storage, xor_hc_storage, found, grid_position.x,
                                thread_position.x, threads_per_threadgroup.x,
