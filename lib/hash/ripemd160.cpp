...
namespace _ripemd160 {
    ...
    inline uint32_t rotate_left(uint32_t x, uint8_t r) {
...
#define ROL(x,n) rotate_left(x,n)
...
// CRIPEMD160::CRIPEMD160: performs cripemd 160.
CRIPEMD160::CRIPEMD160() : bytes(0)
{
    _ripemd160::Initialize(s);
}

// CRIPEMD160::Write: applies one internal step of the PRNG round.
...
// CRIPEMD160::Finalize: performs finalize.
...
// ripemd160_32: performs RIPEMD-160 32.
...
// ripemd160_hex: converts the related data for RIPEMD-160.
