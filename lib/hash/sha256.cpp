...
namespace _sha256
{
    ...
    inline uint32_t rotate_right(uint32_t x, uint8_t r) {
...
#define ROR(x,n) rotate_right(x, n)
...
#define WRITEBE32(ptr,x) *((uint32_t *)(ptr)) = __builtin_bswap32(x)
#define WRITEBE64(ptr,x) *((uint64_t *)(ptr)) = __builtin_bswap64(x)
#define READBE32(ptr) (uint32_t)__builtin_bswap32(*(uint32_t *)(ptr))
...
// CSHA256::CSHA256: performs csha 256.
CSHA256::CSHA256() {
    bytes = 0;
    s[0] = 0x6a09e667ul;
    s[1] = 0xbb67ae85ul;
...
// CSHA256::Write: applies one internal step of the PRNG round.
...
// CSHA256::Finalize: performs finalize.
...
// sha256_checksum: computes 256 checksum.
